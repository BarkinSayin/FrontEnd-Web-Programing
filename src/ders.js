...
const key=Symbol("barkın");
const key1=Symbol("barkın");
console.log(key);
console.log(key1);

const numbers = [1, 2, 3];
const newArray = [...numbers, 4, 5, 6]; // numbers dizisinin elemanlarını kopyala ve yeni elemanlar ekle
...
let a = 5;
let b = a; // b, a'nın değerini kopyalar
a = 10;
console.log(b);
